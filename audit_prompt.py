...
audit_extract_summary_prompt = """
Following is some reponse from an automated audit agent. Your task is to copy the summary they have written.

Write out the summary that the agent has written. Do not add anything else. Do not write comments. Just copy the summary from the input.
